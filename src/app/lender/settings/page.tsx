    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-8xl mx-8 md:mx-16 lg:mx-20 xl:mx-32">
        <div className="space-y-6">
          ...
          <Card className="mt-6 gap-0 p-0 bg-white border-slate-200 shadow-sm hover:shadow-md transition-shadow">
          ...
          {/* Password Section */}
          <Card className="mb-8 gap-0 p-0 bg-white border-slate-200 shadow-sm hover:shadow-md transition-shadow">
            <div className="border-b border-slate-200 px-6 py-4 bg-primary/10">
              <div className="flex items-center gap-3">
